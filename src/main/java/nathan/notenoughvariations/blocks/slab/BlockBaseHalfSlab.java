...
public class BlockBaseHalfSlab extends BlockBaseSlab {
    public BlockBaseHalfSlab(String name, Material material, MapColor mapColor, CreativeTabs creativeTab, float hardness, float resistance, SoundType sound, String toolClass, int level, boolean shearable, BlockBaseDoubleSlab doubleVariant) {
